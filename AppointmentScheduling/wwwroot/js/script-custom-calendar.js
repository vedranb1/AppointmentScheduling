        ...
        if (calendar != null) {
            calendar = new FullCalendar.Calendar(calendar, {
                ...
                eventClick: function (info) {
                    getEvemtDetailsByEventId(info.event);
                }
            });
            calendar.render();
        }
...
function onShowModal(obj, isEventDetail) {
    if (isEventDetail != null) {
        ...
        if (obj.isDoctorApproved) {
            ...
            $("#btnConfirm").html('d-none');
            $("#btnSubmit").html('d-none');
        } else {
...
function getEvemtDetailsByEventId(info) {
    $.ajax({
        url: routeURL + 'Api/Appointment/GetCaledarDataById/' + info.id,
        type: 'GET',
        dataType: 'JSON',
        success: function (response) {
